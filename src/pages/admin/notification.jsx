    ...
    return {
      ...
      content: (
        <>
          ...
          <Button primary onClick={() => openModal({ id: infosTournament.id, name: infosTournament.name })}>
  ...
  return (
    <div id="admin-notif">
      ...
      <Modal
        ...
        buttons={
          <Button primary onClick={checkIfShouldOpenGeneralModal}>
            Envoyer
          </Button>
        }>
        <p>
          Envoyer à : <strong>{currentTournament.name}</strong>
        </p>
