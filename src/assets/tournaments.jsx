...
export default {
  lolpro: {
    ...
    rewards: (
      <ul>
        <li>
          1<sup>ère</sup> équipe : 1700€ + lots
        </li>
        <li>
          2<sup>ème</sup> équipe : lots
        </li>
        <li>
          3<sup>ème</sup> équipe : lots
        </li>
      </ul>
    ),
  ...
  ssbu: {
    ...
    rewards: (
      <ul>
        <li>
          1<sup>er</sup> : 400€ + lots
        </li>
        <li>
          2<sup>ème</sup> : 150€ + lots
        </li>
        <li>
          3<sup>ème</sup> : 100€ + lots
        </li>
      </ul>
    ),
  ...
  csgo: {
    ...
    rewards: (
      <ul>
        <li>
          1<sup>ère</sup> équipe : 1450€ + lots
        </li>
        <li>
          2<sup>ème</sup> équipe : lots
        </li>
  ...
  fortnite: {
    ...
    rewards: (
      <ul>
        <li>
          1<sup>ère</sup> équipe : 1200€ + lots
        </li>
        <li>
          2<sup>ème</sup> équipe : lots
        </li>
  ...
  osu: {
    ...
    format: (
      <>
        ...
        <p>
          Description du tournoi disponible <a href="https://osu.ppy.sh/community/forums/topics/972130">ici</a>.
        </p>
      </>
    ),
  ...
  libre: {
    ...
    format: (
      <>
        <div className="tournament-format">24 joueurs</div>
        <p>
          Le tournoi libre se déroulera sur plusieurs jeux tout au long du week-end, il se veut avant tout fun et
          permettra aux joueurs de montrer leur skill sur différents jeux, pour voir lequel des participants est le plus
          polyvalent. Les différents jeux seront <strong>Mario Kart</strong>, <strong>Super Smash Bros</strong>,{' '}
          <strong>Tricky Towers</strong>, <strong>Worms</strong> et encore plusieurs autres, on aura même à disposition
          un casque VR pour jouer à <strong>Beat Saber</strong>. De plus n’hésitez à nous proposer des idées pour des
          jeux que vous aimeriez voir apparaitre dans le tournoi. Alors si tu crois pouvoir battre tout le monde sur tes
          jeux préférés, n’hésite pas et inscris-toi.
        </p>
      </>
    ),
  },
