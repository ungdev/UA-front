    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <a href={`${uploadsUrl()}/Autorisation_parentale_-_UTT_Arena_2023.pdf`} target="_blank">{' '}disponible ici</a>, <strong>ainsi qu'une photocopie de la pièce d'identité de ton responsable légal et de la tienne</strong>{' '}
