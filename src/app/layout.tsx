...
export const metadata: Metadata = {
  ...
  title: 'UTT Arena 2025 - 28, 29 et 30 novembre 2025',
  description:
    "L'UTT Arena revient les 28, 29 et 30 novembre 2025." +
  ...
  openGraph: {
    siteName: 'UTT Arena 2025',
    title: 'UTT Arena 2025 - 28, 29 et 30 novembre 2025',
    url: appUrl(),
    type: 'website',
    images: [
      {
        url: uploadsUrl() + '/images/banniere_embed.png',
        alt: "Logo de l'UTT Arena",
        width: 1500,
        height: 500,
      },
    ],
    description: 'Entrez dans l’arène les 28, 29 et 30 novembre pour le retour de la compétition esport Troyenne !',
  },
  twitter: {
    title: 'UTT Arena 2025 - 28, 29 et 30 novembre 2025',
    site: '@UTTArena',
    ...
    images: [
      {
        url: uploadsUrl() + '/images/banniere_embed.png',
        alt: "Bannière de l'UTT Arena 2025, les 28, 29 et 30 novembre 2025",
      },
    ],
    description:
      'Entrez dans l’arène les 28, 29 et 30 novembre 2025 pour le retour de la compétition esport Troyenne !',
  },
