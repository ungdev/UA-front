...
export default {
  ung: (
    <>
      ...
      N° RNA : W103000699<br />
      12 rue Marie Curie, 10004 Troyes<br />
      03 26 40 60 00<br />
      ung@utt.fr<br />
    </>
  ),
  ...
  access: (
    <>
      Pour assurer la qualité et la sécurité du réseau et des équipements rattachés d'une part, et la fluidité des échanges et des services offerts d'autre part,
      les organisateurs se réservent le droit de bloquer, altérer ou réaliser toute autre action qu'ils jugeront pertinente sur les échanges réseaux afin d'atteindre les objectifs susmentionnés.
    </>
  ),
  sales: (
    <>
      ...
      <p>
        ...
        La validation de la commande vaut donc acceptation des conditions générales de vente.<br />
      ...
      <p>
        ...
        Les présentes conditions générales de vente sont valables jusqu'au 8 décembre 2019 inclus.
      </p>
      ...
      <p>
        ...
        Ces achats concernent les produits suivants : place pour la LAN et matériel en prévente ou location.
      </p>
      ...
      <p>
        ...
        les informations relatives à l'identité du vendeur, à ses coordonnées postale, téléphonique et électronique, et à ses activités :
        celles relatives aux garanties légales, aux fonctionnalités du contenu numérique et à l'existence et aux modalités de mise en œuvre des garanties et autres conditions contractuelles.
      </p>
      ...
      <p>
        ...
        Toutefois, si des erreurs ou des omissions ont pu se produire quant à cette présentation, la responsabilité du vendeur ne pourrait être engagée.
      ...
      <p>
        ...
        Pour régler sa commande, l'acheteur dispose, à son choix, de l'ensemble des modes de paiements mis à sa disposition par le vendeur et listés sur le site du vendeur.
        ...
        Le paiement du prix s'effectue en totalité au jour de la commande, selon les modalités suivantes : par carte de paiement.
      </p>
      ...
      <p>
        ...
        Ce droit peut être exercé dans les conditions et selon les modalités définies sur le site de l'UTT Arena.
      </p>
    </>
  ),
};