...
import { Title, Collapse, Table, Input } from '../components';
...
const Home = () => {
  ...
  return (
    <div>
      ...
      <Input key="test" label="Test" placeholder="valeur ici" value={value} onChange={(e) => setValue(e.target.value)} />
      <Input key="password" label="mot de passe" value={password} type="password" onChange={(e) => setPassword(e.target.value)} />
    </div>
  );
};
