...
const dataSource = [
  { nom: 'Fontaine', prenom: 'Jean' },
  { prenom: 'Hugo', nom: 'Victor' },
];
...
const Home = () => {
  ...
  return (
    <div>
      ...
      <Input key="test" label="Test" placeholder="valeur ici" value={value} onChange={setValue} />
      <Input key="password" label="mot de passe" value={password} type="password" onChange={setPassword} />
      <Textarea key="textarea" label="Description" placeholder="Long text" value={value} onChange={setValue} />
    </div>
  );
};
